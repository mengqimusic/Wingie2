# Wingie2 v4.03 Web Flasher Guide
...
- `0x1000`: `Wingie2-v4.03.bootloader.bin`
- `0x8000`: `Wingie2-v4.03.partitions.bin`
- `0xe000`: `Wingie2-v4.03.boot_app0.bin`
- `0x10000`: `Wingie2-v4.03.app.bin`

## Installation

1. Close every configuration page, MIDI utility, and serial terminal using the Wingie2 port.
2. Open `Wingie2-v4.03.standalone.html` from its HTTPS address and select “Connect device”. The browser grants access only after you choose a port.
