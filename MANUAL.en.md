...
[`Tools/wingie_config.html`](Tools/wingie_config.html) is a self-contained configuration page that lets you modify and save all settings by connecting Wingie2 via USB in a browser. It needs no Wi-Fi, SoftAP, CDN, Node, or Python—only a Web Serial-capable browser.
