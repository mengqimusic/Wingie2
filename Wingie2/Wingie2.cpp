...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("alt_tuning_ratio_0", &fHslider8, FAUSTFLOAT(1.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(2.0f), FAUSTFLOAT(0.001f));
		ui_interface->addHorizontalSlider("alt_tuning_ratio_1", &fHslider9, FAUSTFLOAT(1.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(2.0f), FAUSTFLOAT(0.001f));
		ui_interface->addHorizontalSlider("alt_tuning_ratio_10", &fHslider18, FAUSTFLOAT(1.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(2.0f), FAUSTFLOAT(0.001f));
		ui_interface->addHorizontalSlider("alt_tuning_ratio_11", &fHslider19, FAUSTFLOAT(1.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(2.0f), FAUSTFLOAT(0.001f));
		ui_interface->addHorizontalSlider("alt_tuning_ratio_2", &fHslider10, FAUSTFLOAT(1.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(2.0f), FAUSTFLOAT(0.001f));
		ui_interface->addHorizontalSlider("alt_tuning_ratio_3", &fHslider11, FAUSTFLOAT(1.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(2.0f), FAUSTFLOAT(0.001f));
		ui_interface->addHorizontalSlider("alt_tuning_ratio_4", &fHslider12, FAUSTFLOAT(1.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(2.0f), FAUSTFLOAT(0.001f));
		ui_interface->addHorizontalSlider("alt_tuning_ratio_5", &fHslider13, FAUSTFLOAT(1.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(2.0f), FAUSTFLOAT(0.001f));
		ui_interface->addHorizontalSlider("alt_tuning_ratio_6", &fHslider14, FAUSTFLOAT(1.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(2.0f), FAUSTFLOAT(0.001f));
		ui_interface->addHorizontalSlider("alt_tuning_ratio_7", &fHslider15, FAUSTFLOAT(1.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(2.0f), FAUSTFLOAT(0.001f));
		ui_interface->addHorizontalSlider("alt_tuning_ratio_8", &fHslider16, FAUSTFLOAT(1.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(2.0f), FAUSTFLOAT(0.001f));
		ui_interface->addHorizontalSlider("alt_tuning_ratio_9", &fHslider17, FAUSTFLOAT(1.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(2.0f), FAUSTFLOAT(0.001f));
		...
		ui_interface->addHorizontalSlider("note0", &fHslider20, FAUSTFLOAT(36.0f), FAUSTFLOAT(12.0f), FAUSTFLOAT(127.0f), FAUSTFLOAT(1.0f));
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow17 = std::fmod(fSlow14, 12.0f);
		...
		float fSlow30 = ((fSlow17 >= 6.0f) ? ((fSlow17 >= 9.0f) ? ((fSlow17 >= 11.0f) ? fSlow29 : ((fSlow17 >= 1e+01f) ? fSlow28 : fSlow27)) : ((fSlow17 >= 8.0f) ? fSlow26 : ((fSlow17 >= 7.0f) ? fSlow25 : fSlow24))) : ((fSlow17 >= 3.0f) ? ((fSlow17 >= 5.0f) ? fSlow23 : ((fSlow17 >= 4.0f) ? fSlow22 : fSlow21)) : ((fSlow17 >= 2.0f) ? fSlow20 : ((fSlow17 >= 1.0f) ? fSlow19 : fSlow18))));
		float fSlow31 = fSlow15 * std::pow(2.0f, 0.083333336f * (fSlow14 + (-69.0f - fSlow17)));
		float fSlow32 = float(fHslider20);
		float fSlow33 = fSlow15 * std::pow(2.0f, 0.083333336f * (fSlow32 + -69.0f));
		float fSlow34 = std::fmod(fSlow32, 12.0f);
		float fSlow35 = ((fSlow34 >= 6.0f) ? ((fSlow34 >= 9.0f) ? ((fSlow34 >= 11.0f) ? fSlow29 : ((fSlow34 >= 1e+01f) ? fSlow28 : fSlow27)) : ((fSlow34 >= 8.0f) ? fSlow26 : ((fSlow34 >= 7.0f) ? fSlow25 : fSlow24))) : ((fSlow34 >= 3.0f) ? ((fSlow34 >= 5.0f) ? fSlow23 : ((fSlow34 >= 4.0f) ? fSlow22 : fSlow21)) : ((fSlow34 >= 2.0f) ? fSlow20 : ((fSlow34 >= 1.0f) ? fSlow19 : fSlow18))));
		float fSlow36 = fSlow15 * std::pow(2.0f, 0.083333336f * (fSlow32 + (-69.0f - fSlow34)));
		float fSlow37 = ((iSlow13) ? fSlow36 * fSlow35 : fSlow33);
		int iSlow38 = fSlow10 >= 3.0f;
		float fSlow39 = std::min<float>(((iSlow11) ? ((iSlow38) ? float(fVslider1) : ((iSlow13) ? 40.11071f * fSlow36 * fSlow35 : 40.11071f * fSlow33)) : ((iSlow12) ? 9.0f * fSlow37 : ((iSlow13) ? 3.0f * fSlow31 * fSlow30 : 3.0f * fSlow16))), 1.6e+04f);
		float fSlow40 = std::cos(fConst9 * fSlow39);
		float fSlow41 = mydsp_faustpower2_f(float(fHslider21));
		float fSlow42 = fConst5 * float(((fSlow39 == 1.6e+04f) ? 0 : 1));
		float fSlow43 = float(fButton4);
		int iSlow44 = fSlow43 == 0.0f;
		float fSlow45 = std::min<float>(((iSlow11) ? ((iSlow38) ? float(fVslider2) : ((iSlow13) ? 32.11079f * fSlow36 * fSlow35 : 32.11079f * fSlow33)) : ((iSlow12) ? 8.0f * fSlow37 : ((iSlow13) ? 2.0f * fSlow31 * fSlow30 : 2.0f * fSlow16))), 1.6e+04f);
		float fSlow46 = std::cos(fConst9 * fSlow45);
		float fSlow47 = fConst5 * float(((fSlow45 == 1.6e+04f) ? 0 : 1));
		float fSlow48 = float(fButton5);
		int iSlow49 = fSlow48 == 0.0f;
		float fSlow50 = std::min<float>(((iSlow11) ? ((iSlow38) ? float(fVslider3) : ((iSlow13) ? 24.99975f * fSlow36 * fSlow35 : 24.99975f * fSlow33)) : ((iSlow12) ? 7.0f * fSlow37 : ((iSlow13) ? fSlow31 * fSlow30 : fSlow16))), 1.6e+04f);
		float fSlow51 = std::cos(fConst9 * fSlow50);
		float fSlow52 = fConst5 * float(((fSlow50 == 1.6e+04f) ? 0 : 1));
		float fSlow53 = float(fButton6);
		int iSlow54 = fSlow53 == 0.0f;
		float fSlow55 = float(fVslider4);
		float fSlow56 = fSlow15 * std::pow(2.0f, 0.083333336f * (fSlow55 + -69.0f));
		float fSlow57 = std::fmod(fSlow55, 12.0f);
		float fSlow58 = ((fSlow57 >= 6.0f) ? ((fSlow57 >= 9.0f) ? ((fSlow57 >= 11.0f) ? fSlow29 : ((fSlow57 >= 1e+01f) ? fSlow28 : fSlow27)) : ((fSlow57 >= 8.0f) ? fSlow26 : ((fSlow57 >= 7.0f) ? fSlow25 : fSlow24))) : ((fSlow57 >= 3.0f) ? ((fSlow57 >= 5.0f) ? fSlow23 : ((fSlow57 >= 4.0f) ? fSlow22 : fSlow21)) : ((fSlow57 >= 2.0f) ? fSlow20 : ((fSlow57 >= 1.0f) ? fSlow19 : fSlow18))));
		float fSlow59 = fSlow15 * std::pow(2.0f, 0.083333336f * (fSlow55 + (-69.0f - fSlow57)));
		float fSlow60 = std::min<float>(((iSlow11) ? ((iSlow38) ? float(fVslider5) : ((iSlow13) ? 18.77759f * fSlow36 * fSlow35 : 18.77759f * fSlow33)) : ((iSlow12) ? 6.0f * fSlow37 : ((iSlow13) ? 3.0f * fSlow59 * fSlow58 : 3.0f * fSlow56))), 1.6e+04f);
		...
		float fSlow65 = std::min<float>(((iSlow11) ? ((iSlow38) ? float(fVslider6) : ((iSlow13) ? 13.44431f * fSlow36 * fSlow35 : 13.44431f * fSlow33)) : ((iSlow12) ? 5.0f * fSlow37 : ((iSlow13) ? 2.0f * fSlow59 * fSlow58 : 2.0f * fSlow56))), 1.6e+04f);
		...
		float fSlow70 = std::min<float>(((iSlow11) ? ((iSlow38) ? float(fVslider7) : ((iSlow13) ? 8.99991f * fSlow36 * fSlow35 : 8.99991f * fSlow33)) : ((iSlow12) ? 4.0f * fSlow37 : ((iSlow13) ? fSlow59 * fSlow58 : fSlow56))), 1.6e+04f);
		float fSlow71 = std::cos(fConst9 * fSlow70);
		float fSlow72 = fConst5 * float(((fSlow70 == 1.6e+04f) ? 0 : 1));
		float fSlow73 = float(fButton9);
		int iSlow74 = fSlow73 == 0.0f;
		float fSlow75 = float(fVslider8);
		float fSlow76 = fSlow15 * std::pow(2.0f, 0.083333336f * (fSlow75 + -69.0f));
		float fSlow77 = std::fmod(fSlow75, 12.0f);
		float fSlow78 = ((fSlow77 >= 6.0f) ? ((fSlow77 >= 9.0f) ? ((fSlow77 >= 11.0f) ? fSlow29 : ((fSlow77 >= 1e+01f) ? fSlow28 : fSlow27)) : ((fSlow77 >= 8.0f) ? fSlow26 : ((fSlow77 >= 7.0f) ? fSlow25 : fSlow24))) : ((fSlow77 >= 3.0f) ? ((fSlow77 >= 5.0f) ? fSlow23 : ((fSlow77 >= 4.0f) ? fSlow22 : fSlow21)) : ((fSlow77 >= 2.0f) ? fSlow20 : ((fSlow77 >= 1.0f) ? fSlow19 : fSlow18))));
		float fSlow79 = fSlow15 * std::pow(2.0f, 0.083333336f * (fSlow75 + (-69.0f - fSlow77)));
		float fSlow80 = std::min<float>(((iSlow11) ? ((iSlow38) ? float(fVslider9) : ((iSlow13) ? 5.44439f * fSlow36 * fSlow35 : 5.44439f * fSlow33)) : ((iSlow12) ? 3.0f * fSlow37 : ((iSlow13) ? 3.0f * fSlow79 * fSlow78 : 3.0f * fSlow76))), 1.6e+04f);
		float fSlow81 = std::cos(fConst9 * fSlow80);
		float fSlow82 = fConst5 * float(((fSlow80 == 1.6e+04f) ? 0 : 1));
		float fSlow83 = float(fButton10);
		int iSlow84 = fSlow83 == 0.0f;
		float fSlow85 = std::min<float>(((iSlow11) ? ((iSlow38) ? float(fVslider10) : ((iSlow13) ? 2.77775f * fSlow36 * fSlow35 : 2.77775f * fSlow33)) : ((iSlow12) ? 2.0f * fSlow37 : ((iSlow13) ? 2.0f * fSlow79 * fSlow78 : 2.0f * fSlow76))), 1.6e+04f);
		float fSlow86 = std::cos(fConst9 * fSlow85);
		float fSlow87 = fConst5 * float(((fSlow85 == 1.6e+04f) ? 0 : 1));
		float fSlow88 = float(fButton11);
		int iSlow89 = fSlow88 == 0.0f;
		float fSlow90 = std::min<float>(((iSlow11) ? ((iSlow38) ? float(fVslider11) : ((iSlow13) ? 0.99999f * fSlow36 * fSlow35 : 0.99999f * fSlow33)) : ((iSlow12) ? fSlow37 : ((iSlow13) ? fSlow79 * fSlow78 : fSlow76))), 1.6e+04f);
		float fSlow91 = std::cos(fConst9 * fSlow90);
		float fSlow92 = fConst5 * float(((fSlow90 == 1.6e+04f) ? 0 : 1));
		float fSlow93 = 1.0471286f * mydsp_faustpower2_f(float(fHslider22));
		float fSlow94 = mydsp_faustpower2_f(float(fHslider23));
		float fSlow95 = float(fHslider24);
		float fSlow96 = fConst5 * float(fHslider25);
		float fSlow97 = fConst5 * mydsp_faustpower2_f(float(fHslider26));
		float fSlow98 = float(fButton12);
		int iSlow99 = fSlow98 == 0.0f;
		float fSlow100 = float(fButton13);
		float fSlow101 = 1.0f / std::max<float>(1.0f, fConst0 * float(fHslider27));
		float fSlow102 = fConst5 * float(fHslider28);
		float fSlow103 = float(fHslider29);
		int iSlow104 = fSlow103 >= 2.0f;
		int iSlow105 = fSlow103 >= 1.0f;
		float fSlow106 = float(fVslider12);
		float fSlow107 = fSlow15 * std::pow(2.0f, 0.083333336f * (fSlow106 + -69.0f));
		float fSlow108 = std::fmod(fSlow106, 12.0f);
		float fSlow109 = ((fSlow108 >= 6.0f) ? ((fSlow108 >= 9.0f) ? ((fSlow108 >= 11.0f) ? fSlow29 : ((fSlow108 >= 1e+01f) ? fSlow28 : fSlow27)) : ((fSlow108 >= 8.0f) ? fSlow26 : ((fSlow108 >= 7.0f) ? fSlow25 : fSlow24))) : ((fSlow108 >= 3.0f) ? ((fSlow108 >= 5.0f) ? fSlow23 : ((fSlow108 >= 4.0f) ? fSlow22 : fSlow21)) : ((fSlow108 >= 2.0f) ? fSlow20 : ((fSlow108 >= 1.0f) ? fSlow19 : fSlow18))));
		float fSlow110 = fSlow15 * std::pow(2.0f, 0.083333336f * (fSlow106 + (-69.0f - fSlow108)));
		float fSlow111 = float(fHslider30);
		float fSlow112 = fSlow15 * std::pow(2.0f, 0.083333336f * (fSlow111 + -69.0f));
		float fSlow113 = std::fmod(fSlow111, 12.0f);
		float fSlow114 = ((fSlow113 >= 6.0f) ? ((fSlow113 >= 9.0f) ? ((fSlow113 >= 11.0f) ? fSlow29 : ((fSlow113 >= 1e+01f) ? fSlow28 : fSlow27)) : ((fSlow113 >= 8.0f) ? fSlow26 : ((fSlow113 >= 7.0f) ? fSlow25 : fSlow24))) : ((fSlow113 >= 3.0f) ? ((fSlow113 >= 5.0f) ? fSlow23 : ((fSlow113 >= 4.0f) ? fSlow22 : fSlow21)) : ((fSlow113 >= 2.0f) ? fSlow20 : ((fSlow113 >= 1.0f) ? fSlow19 : fSlow18))));
		float fSlow115 = fSlow15 * std::pow(2.0f, 0.083333336f * (fSlow111 + (-69.0f - fSlow113)));
		float fSlow116 = ((iSlow13) ? fSlow115 * fSlow114 : fSlow112);
		int iSlow117 = fSlow103 >= 3.0f;
		float fSlow118 = std::min<float>(((iSlow104) ? ((iSlow117) ? float(fVslider13) : ((iSlow13) ? 40.11071f * fSlow115 * fSlow114 : 40.11071f * fSlow112)) : ((iSlow105) ? 9.0f * fSlow116 : ((iSlow13) ? 3.0f * fSlow110 * fSlow109 : 3.0f * fSlow107))), 1.6e+04f);
		...
		float fSlow123 = std::min<float>(((iSlow104) ? ((iSlow117) ? float(fVslider14) : ((iSlow13) ? 32.11079f * fSlow115 * fSlow114 : 32.11079f * fSlow112)) : ((iSlow105) ? 8.0f * fSlow116 : ((iSlow13) ? 2.0f * fSlow110 * fSlow109 : 2.0f * fSlow107))), 1.6e+04f);
		float fSlow124 = std::cos(fConst9 * fSlow123);
		float fSlow125 = fConst5 * float(((fSlow123 == 1.6e+04f) ? 0 : 1));
		float fSlow126 = float(fButton15);
		int iSlow127 = fSlow126 == 0.0f;
		float fSlow128 = std::min<float>(((iSlow104) ? ((iSlow117) ? float(fVslider15) : ((iSlow13) ? 24.99975f * fSlow115 * fSlow114 : 24.99975f * fSlow112)) : ((iSlow105) ? 7.0f * fSlow116 : ((iSlow13) ? fSlow110 * fSlow109 : fSlow107))), 1.6e+04f);
		float fSlow129 = std::cos(fConst9 * fSlow128);
		float fSlow130 = fConst5 * float(((fSlow128 == 1.6e+04f) ? 0 : 1));
		float fSlow131 = float(fButton16);
		int iSlow132 = fSlow131 == 0.0f;
		float fSlow133 = float(fVslider16);
		float fSlow134 = fSlow15 * std::pow(2.0f, 0.083333336f * (fSlow133 + -69.0f));
		float fSlow135 = std::fmod(fSlow133, 12.0f);
		float fSlow136 = ((fSlow135 >= 6.0f) ? ((fSlow135 >= 9.0f) ? ((fSlow135 >= 11.0f) ? fSlow29 : ((fSlow135 >= 1e+01f) ? fSlow28 : fSlow27)) : ((fSlow135 >= 8.0f) ? fSlow26 : ((fSlow135 >= 7.0f) ? fSlow25 : fSlow24))) : ((fSlow135 >= 3.0f) ? ((fSlow135 >= 5.0f) ? fSlow23 : ((fSlow135 >= 4.0f) ? fSlow22 : fSlow21)) : ((fSlow135 >= 2.0f) ? fSlow20 : ((fSlow135 >= 1.0f) ? fSlow19 : fSlow18))));
		float fSlow137 = fSlow15 * std::pow(2.0f, 0.083333336f * (fSlow133 + (-69.0f - fSlow135)));
		float fSlow138 = std::min<float>(((iSlow104) ? ((iSlow117) ? float(fVslider17) : ((iSlow13) ? 18.77759f * fSlow115 * fSlow114 : 18.77759f * fSlow112)) : ((iSlow105) ? 6.0f * fSlow116 : ((iSlow13) ? 3.0f * fSlow137 * fSlow136 : 3.0f * fSlow134))), 1.6e+04f);
		float fSlow139 = std::cos(fConst9 * fSlow138);
		float fSlow140 = fConst5 * float(((fSlow138 == 1.6e+04f) ? 0 : 1));
		float fSlow141 = float(fButton17);
		int iSlow142 = fSlow141 == 0.0f;
		float fSlow143 = std::min<float>(((iSlow104) ? ((iSlow117) ? float(fVslider18) : ((iSlow13) ? 13.44431f * fSlow115 * fSlow114 : 13.44431f * fSlow112)) : ((iSlow105) ? 5.0f * fSlow116 : ((iSlow13) ? 2.0f * fSlow137 * fSlow136 : 2.0f * fSlow134))), 1.6e+04f);
		float fSlow144 = std::cos(fConst9 * fSlow143);
		float fSlow145 = fConst5 * float(((fSlow143 == 1.6e+04f) ? 0 : 1));
		float fSlow146 = float(fButton18);
		int iSlow147 = fSlow146 == 0.0f;
		float fSlow148 = std::min<float>(((iSlow104) ? ((iSlow117) ? float(fVslider19) : ((iSlow13) ? 8.99991f * fSlow115 * fSlow114 : 8.99991f * fSlow112)) : ((iSlow105) ? 4.0f * fSlow116 : ((iSlow13) ? fSlow137 * fSlow136 : fSlow134))), 1.6e+04f);
		float fSlow149 = std::cos(fConst9 * fSlow148);
		float fSlow150 = fConst5 * float(((fSlow148 == 1.6e+04f) ? 0 : 1));
		float fSlow151 = float(fButton19);
		int iSlow152 = fSlow151 == 0.0f;
		float fSlow153 = float(fVslider20);
		float fSlow154 = fSlow15 * std::pow(2.0f, 0.083333336f * (fSlow153 + -69.0f));
		float fSlow155 = std::fmod(fSlow153, 12.0f);
		float fSlow156 = ((fSlow155 >= 6.0f) ? ((fSlow155 >= 9.0f) ? ((fSlow155 >= 11.0f) ? fSlow29 : ((fSlow155 >= 1e+01f) ? fSlow28 : fSlow27)) : ((fSlow155 >= 8.0f) ? fSlow26 : ((fSlow155 >= 7.0f) ? fSlow25 : fSlow24))) : ((fSlow155 >= 3.0f) ? ((fSlow155 >= 5.0f) ? fSlow23 : ((fSlow155 >= 4.0f) ? fSlow22 : fSlow21)) : ((fSlow155 >= 2.0f) ? fSlow20 : ((fSlow155 >= 1.0f) ? fSlow19 : fSlow18))));
		float fSlow157 = fSlow15 * std::pow(2.0f, 0.083333336f * (fSlow153 + (-69.0f - fSlow155)));
		float fSlow158 = std::min<float>(((iSlow104) ? ((iSlow117) ? float(fVslider21) : ((iSlow13) ? 5.44439f * fSlow115 * fSlow114 : 5.44439f * fSlow112)) : ((iSlow105) ? 3.0f * fSlow116 : ((iSlow13) ? 3.0f * fSlow157 * fSlow156 : 3.0f * fSlow154))), 1.6e+04f);
		float fSlow159 = std::cos(fConst9 * fSlow158);
		float fSlow160 = fConst5 * float(((fSlow158 == 1.6e+04f) ? 0 : 1));
		float fSlow161 = float(fButton20);
		int iSlow162 = fSlow161 == 0.0f;
		float fSlow163 = std::min<float>(((iSlow104) ? ((iSlow117) ? float(fVslider22) : ((iSlow13) ? 2.77775f * fSlow115 * fSlow114 : 2.77775f * fSlow112)) : ((iSlow105) ? 2.0f * fSlow116 : ((iSlow13) ? 2.0f * fSlow157 * fSlow156 : 2.0f * fSlow154))), 1.6e+04f);
		float fSlow164 = std::cos(fConst9 * fSlow163);
		float fSlow165 = fConst5 * float(((fSlow163 == 1.6e+04f) ? 0 : 1));
		float fSlow166 = float(fButton21);
		int iSlow167 = fSlow166 == 0.0f;
		float fSlow168 = std::min<float>(((iSlow104) ? ((iSlow117) ? float(fVslider23) : ((iSlow13) ? 0.99999f * fSlow115 * fSlow114 : 0.99999f * fSlow112)) : ((iSlow105) ? fSlow116 : ((iSlow13) ? fSlow157 * fSlow156 : fSlow154))), 1.6e+04f);
		float fSlow169 = std::cos(fConst9 * fSlow168);
		float fSlow170 = fConst5 * float(((fSlow168 == 1.6e+04f) ? 0 : 1));
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp9 = fSlow41 * fRec4[0] * fTemp4 * fTemp1;
			fVec4[0] = fTemp9;
			fRec10[0] = 0.0f - fConst12 * (fConst11 * fRec10[1] - (fTemp9 + fVec4[1]));
			fRec7[0] = fRec10[0] - (fTemp8 * fRec7[1] * fSlow40 + fTemp7 * fRec7[2]);
			fRec11[0] = fSlow42 + fConst6 * fRec11[1];
			fVec5[0] = fSlow43;
			iRec12[0] = iSlow44 * (iRec12[1] + 1);
			fRec13[0] = fSlow43 + fRec13[1] * float(fVec5[1] >= fSlow43);
			fRec14[0] = fRec10[0] - (fTemp8 * fRec14[1] * fSlow46 + fTemp7 * fRec14[2]);
			fRec15[0] = fSlow47 + fConst6 * fRec15[1];
			fVec6[0] = fSlow48;
			iRec16[0] = iSlow49 * (iRec16[1] + 1);
			fRec17[0] = fSlow48 + fRec17[1] * float(fVec6[1] >= fSlow48);
			fRec18[0] = fRec10[0] - (fTemp8 * fRec18[1] * fSlow51 + fTemp7 * fRec18[2]);
			fRec19[0] = fSlow52 + fConst6 * fRec19[1];
			fVec7[0] = fSlow53;
			iRec20[0] = iSlow54 * (iRec20[1] + 1);
			fRec21[0] = fSlow53 + fRec21[1] * float(fVec7[1] >= fSlow53);
			fRec22[0] = fRec10[0] - (fTemp8 * fRec22[1] * fSlow61 + fTemp7 * fRec22[2]);
			fRec23[0] = fSlow62 + fConst6 * fRec23[1];
			fVec8[0] = fSlow63;
			iRec24[0] = iSlow64 * (iRec24[1] + 1);
			fRec25[0] = fSlow63 + fRec25[1] * float(fVec8[1] >= fSlow63);
			fRec26[0] = fRec10[0] - (fTemp8 * fRec26[1] * fSlow66 + fTemp7 * fRec26[2]);
			fRec27[0] = fSlow67 + fConst6 * fRec27[1];
			fVec9[0] = fSlow68;
			iRec28[0] = iSlow69 * (iRec28[1] + 1);
			fRec29[0] = fSlow68 + fRec29[1] * float(fVec9[1] >= fSlow68);
			fRec30[0] = fRec10[0] - (fTemp8 * fRec30[1] * fSlow71 + fTemp7 * fRec30[2]);
			fRec31[0] = fSlow72 + fConst6 * fRec31[1];
			fVec10[0] = fSlow73;
			iRec32[0] = iSlow74 * (iRec32[1] + 1);
			fRec33[0] = fSlow73 + fRec33[1] * float(fVec10[1] >= fSlow73);
			fRec34[0] = fRec10[0] - (fTemp8 * fRec34[1] * fSlow81 + fTemp7 * fRec34[2]);
			fRec35[0] = fSlow82 + fConst6 * fRec35[1];
			fVec11[0] = fSlow83;
			iRec36[0] = iSlow84 * (iRec36[1] + 1);
			fRec37[0] = fSlow83 + fRec37[1] * float(fVec11[1] >= fSlow83);
			fRec38[0] = fRec10[0] - (fTemp8 * fRec38[1] * fSlow86 + fTemp7 * fRec38[2]);
			fRec39[0] = fSlow87 + fConst6 * fRec39[1];
			fVec12[0] = fSlow88;
			...
			fRec46[0] = fSlow96 + fConst6 * fRec46[1];
			fRec47[0] = fSlow97 + fConst6 * fRec47[1];
			fVec14[0] = fSlow98;
			...
			fRec52[0] = fSlow102 + fConst6 * fRec52[1];
			float fTemp15 = std::pow(0.001f, fConst8 / (fRec52[0] * (1.0f - std::max<float>(0.0f, std::min<float>(fConst2 * fTemp14, fSlow101 * (fConst1 - fTemp14) + 1.0f))) + 0.05f));
			float fTemp16 = mydsp_faustpower2_f(fTemp15);
			float fTemp17 = 0.0f - 2.0f * fTemp15;
			float fTemp18 = fSlow41 * fRec47[0] * fTemp13 * fTemp1;
			fVec16[0] = fTemp18;
			fRec53[0] = 0.0f - fConst12 * (fConst11 * fRec53[1] - (fTemp18 + fVec16[1]));
			fRec50[0] = fRec53[0] - (fTemp17 * fRec50[1] * fSlow119 + fTemp16 * fRec50[2]);
			fRec54[0] = fSlow120 + fConst6 * fRec54[1];
			fVec17[0] = fSlow121;
			iRec55[0] = iSlow122 * (iRec55[1] + 1);
			fRec56[0] = fSlow121 + fRec56[1] * float(fVec17[1] >= fSlow121);
			fRec57[0] = fRec53[0] - (fTemp17 * fRec57[1] * fSlow124 + fTemp16 * fRec57[2]);
			fRec58[0] = fSlow125 + fConst6 * fRec58[1];
			fVec18[0] = fSlow126;
			iRec59[0] = iSlow127 * (iRec59[1] + 1);
			fRec60[0] = fSlow126 + fRec60[1] * float(fVec18[1] >= fSlow126);
			fRec61[0] = fRec53[0] - (fTemp17 * fRec61[1] * fSlow129 + fTemp16 * fRec61[2]);
			fRec62[0] = fSlow130 + fConst6 * fRec62[1];
			fVec19[0] = fSlow131;
			iRec63[0] = iSlow132 * (iRec63[1] + 1);
			fRec64[0] = fSlow131 + fRec64[1] * float(fVec19[1] >= fSlow131);
			fRec65[0] = fRec53[0] - (fTemp17 * fRec65[1] * fSlow139 + fTemp16 * fRec65[2]);
			fRec66[0] = fSlow140 + fConst6 * fRec66[1];
			fVec20[0] = fSlow141;
			iRec67[0] = iSlow142 * (iRec67[1] + 1);
			fRec68[0] = fSlow141 + fRec68[1] * float(fVec20[1] >= fSlow141);
			fRec69[0] = fRec53[0] - (fTemp17 * fRec69[1] * fSlow144 + fTemp16 * fRec69[2]);
			fRec70[0] = fSlow145 + fConst6 * fRec70[1];
			fVec21[0] = fSlow146;
			iRec71[0] = iSlow147 * (iRec71[1] + 1);
			fRec72[0] = fSlow146 + fRec72[1] * float(fVec21[1] >= fSlow146);
			fRec73[0] = fRec53[0] - (fTemp17 * fRec73[1] * fSlow149 + fTemp16 * fRec73[2]);
			fRec74[0] = fSlow150 + fConst6 * fRec74[1];
			fVec22[0] = fSlow151;
			iRec75[0] = iSlow152 * (iRec75[1] + 1);
			fRec76[0] = fSlow151 + fRec76[1] * float(fVec22[1] >= fSlow151);
			fRec77[0] = fRec53[0] - (fTemp17 * fRec77[1] * fSlow159 + fTemp16 * fRec77[2]);
			fRec78[0] = fSlow160 + fConst6 * fRec78[1];
			fVec23[0] = fSlow161;
			iRec79[0] = iSlow162 * (iRec79[1] + 1);
			fRec80[0] = fSlow161 + fRec80[1] * float(fVec23[1] >= fSlow161);
			fRec81[0] = fRec53[0] - (fTemp17 * fRec81[1] * fSlow164 + fTemp16 * fRec81[2]);
			fRec82[0] = fSlow165 + fConst6 * fRec82[1];
			fVec24[0] = fSlow166;
			iRec83[0] = iSlow167 * (iRec83[1] + 1);
			fRec84[0] = fSlow166 + fRec84[1] * float(fVec24[1] >= fSlow166);
			fRec85[0] = fRec53[0] - (fRec85[1] * fTemp17 * fSlow169 + fRec85[2] * fTemp16);
			fRec86[0] = fSlow170 + fConst6 * fRec86[1];
			float fTemp19 = std::max<float>(-1.0f, std::min<float>(1.0f, fSlow93 * (mydsp_faustpower2_f(fRec86[0]) * (fRec85[0] - fRec85[2]) * mydsp_faustpower2_f(1.0f - std::max<float>(0.0f, std::min<float>(fConst7 * fRec84[0], 1.0f) - fConst7 * float(iRec83[0]))) + mydsp_faustpower2_f(fRec82[0]) * (fRec81[0] - fRec81[2]) * mydsp_faustpower2_f(1.0f - std::max<float>(0.0f, std::min<float>(fConst7 * fRec80[0], 1.0f) - fConst7 * float(iRec79[0]))) + mydsp_faustpower2_f(fRec78[0]) * (fRec77[0] - fRec77[2]) * mydsp_faustpower2_f(1.0f - std::max<float>(0.0f, std::min<float>(fConst7 * fRec76[0], 1.0f) - fConst7 * float(iRec75[0]))) + mydsp_faustpower2_f(fRec74[0]) * (fRec73[0] - fRec73[2]) * mydsp_faustpower2_f(1.0f - std::max<float>(0.0f, std::min<float>(fConst7 * fRec72[0], 1.0f) - fConst7 * float(iRec71[0]))) + mydsp_faustpower2_f(fRec70[0]) * (fRec69[0] - fRec69[2]) * mydsp_faustpower2_f(1.0f - std::max<float>(0.0f, std::min<float>(fConst7 * fRec68[0], 1.0f) - fConst7 * float(iRec67[0]))) + mydsp_faustpower2_f(fRec66[0]) * (fRec65[0] - fRec65[2]) * mydsp_faustpower2_f(1.0f - std::max<float>(0.0f, std::min<float>(fConst7 * fRec64[0], 1.0f) - fConst7 * float(iRec63[0]))) + mydsp_faustpower2_f(fRec62[0]) * (fRec61[0] - fRec61[2]) * mydsp_faustpower2_f(1.0f - std::max<float>(0.0f, std::min<float>(fConst7 * fRec60[0], 1.0f) - fConst7 * float(iRec59[0]))) + mydsp_faustpower2_f(fRec58[0]) * (fRec57[0] - fRec57[2]) * mydsp_faustpower2_f(1.0f - std::max<float>(0.0f, std::min<float>(fConst7 * fRec56[0], 1.0f) - fConst7 * float(iRec55[0]))) + mydsp_faustpower2_f(fRec54[0]) * (fRec50[0] - fRec50[2]) * mydsp_faustpower2_f(1.0f - std::max<float>(0.0f, std::min<float>(fConst7 * fRec49[0], 1.0f) - fConst7 * float(iRec48[0]))))));
