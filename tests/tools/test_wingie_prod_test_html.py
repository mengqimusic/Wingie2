...
class WingieProdTestHtmlTest(unittest.TestCase):
    ...
    def test_serial_protocol_matches_firmware(self):
        ...
        self.assertIn("encodeControlCounts(", self.response_source)
        self.assertIn(r'op\":\"get_controls\"', self.response_source)
        self.assertIn(r'firmware\":\"%s', self.response_source)
        self.assertIn("encodeHello(", self.response_source)
        ...
        for field in ("key", "mode_button", "oct_button", "source_switch", "pot"):
            self.assertIn(field, self.response_source)
        self.assertIn(r'"midi_rx\"', self.response_source)
